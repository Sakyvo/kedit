  ...
  new Feature(
    ...
    [
      ...
      new Feature(
        'sponsor',
        '赞助',
        '使用 Gitee 登录并赞助 KEDIT 以解锁 PDF 和 Pandoc 导出。（暂不支持赞助）',
      ),
    ],
  ),
  new Feature(
  ...
  new Feature(
    ...
    [
      new Feature(
        'addBloggerAccount',
        'Blogger账号',
        '将您的Blogger账号链接到KEDIT。',
      ),
      new Feature(
        'addDropboxAccount',
        'Dropbox账号',
        '将您的Dropbox账号链接到KEDIT。',
      ),
      new Feature(
        'addGitHubAccount',
        'GitHub账号',
      ...
      new Feature(
        ...
        'Google Drive账号',
        '将您的Google Drive账号链接到KEDIT。',
      ),
      new Feature(
        'addGooglePhotosAccount',
        'Google Photos账号',
        '将您的Google Photos账号链接到KEDIT。',
      ),
      new Feature(
        'addWordpressAccount',
        'WordPress账号',
        '将您的WordPress账号链接到KEDIT。',
      ),
      new Feature(
        'addZendeskAccount',
        'Zendesk账号',
        '将您的Zendesk账号链接到KEDIT。',
      ),
      new Feature(
        'addSmmsAccount',
        'SM.MS账号',
